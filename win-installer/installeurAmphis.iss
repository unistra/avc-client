...
; Searching for specific conf. file for amphis mod and the university  
Source: ..\confsFiles\amphisUnistra\mediacours.conf; DestDir:{%ALLUSERSPROFILE}\audiovideocours ; Permissions: everyone-modify
...
[Icons]
; removing menu and shortcuts entries
