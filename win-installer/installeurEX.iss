...
AppVerName=audiovideocours EX external
AppVersion=0.90
...
[Files]
;Source: ..\MediaCoursEX.conf; DestDir:{%USERPROFILE}
Source: ..\videolog.py; DestDir:{app}
Source: ..\MediaCoursExt.conf; DestDir:{app}
...
Source: ..\dist\_imagingft.pyd; DestDir:{app}
...
Source: ..\dist\mediacoursEX.exe; DestDir:{app}
...
Source: ..\dist\vidcap.dll; DestDir:{app}
...
[Icons]
Name: {group}\AudioCours; Filename: {app}\mediacoursEX.exe; WorkingDir: {app}; IconFilename: {app}\audiocours2.ico
Name: {commondesktop}\AudioCours; Filename: {app}\mediacoursEX.exe; WorkingDir: {app}; IconFilename: {app}\audiocours1.ico
